...
--	Logic.SetTechnologyState(PlayerID,Technologies.UP2_Claymine      	,2 )
	...
	--	
		...
		Logic.SetTechnologyState(PlayerID,Technologies.T_MarketGold, 2)
  		Logic.SetTechnologyState(PlayerID,Technologies.T_MarketClay, 2)
		Logic.SetTechnologyState(PlayerID,Technologies.T_MarketWood, 2)
		Logic.SetTechnologyState(PlayerID,Technologies.T_MarketIron, 2)
		Logic.SetTechnologyState(PlayerID,Technologies.T_MarketStone, 0)
		Logic.SetTechnologyState(PlayerID,Technologies.T_MarketSulfur, 2)
