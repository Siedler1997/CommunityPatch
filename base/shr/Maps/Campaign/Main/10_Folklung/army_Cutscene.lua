createArmyCutscene = function()
	...
	Bow1ID = AI.Entity_CreateFormation(gvMission.PlayerIDBesieger,Entities.PU_LeaderBow2a,0,16,Bow1Pos.X,Bow1Pos.Y,0,0,3,0)
	Bow2ID = AI.Entity_CreateFormation(gvMission.PlayerIDBesieger,Entities.PU_LeaderBow2a,0,16,Bow2Pos.X,Bow2Pos.Y,0,0,3,0)
	Bow3ID = AI.Entity_CreateFormation(gvMission.PlayerIDBesieger,Entities.PU_LeaderBow2a,0,16,Bow3Pos.X,Bow3Pos.Y,0,0,3,0)
	...
	Cannon1ID = Tools.CreateGroup(gvMission.PlayerIDBesieger, Entities.PV_Cannon3a, 9, Cannon1Pos.X, Cannon1Pos.Y, -5)
	Cannon2ID = Tools.CreateGroup(gvMission.PlayerIDBesieger, Entities.PV_Cannon3a, 9, Cannon2Pos.X, Cannon2Pos.Y, -5)
	Cannon3ID = Tools.CreateGroup(gvMission.PlayerIDBesieger, Entities.PV_Cannon3a, 9, Cannon3Pos.X, Cannon3Pos.Y, -5)
