...
function Mission_InitPlayerColorMapping()
	...
	if p1color == 2 then
		Display.SetPlayerColorMapping(2, 6)		-- Dartmoor
		Display.SetPlayerColorMapping(4, 6)		-- Dartmoor
		Display.SetPlayerColorMapping(5, 6)		-- Dartmoor Serfs
	else
		Display.SetPlayerColorMapping(2, 2)		-- Dartmoor
		Display.SetPlayerColorMapping(4, 2)		-- Dartmoor
		Display.SetPlayerColorMapping(5, 2)		-- Dartmoor Serfs
	end
