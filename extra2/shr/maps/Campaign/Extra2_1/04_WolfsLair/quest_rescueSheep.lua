MAX_RESCUE_SHEEP_COUNT = 20
NECESSARY_SHEEP_COUNT = 15
...
function QuestRescueSheep()
	...
	if not IsBriefingActive() and not IsCutsceneActive() then
		...
		for i=1,MAX_RESCUE_SHEEP_COUNT do
			...
			expeditionQuest.TargetName		=	"sheepGate"
			expeditionQuest.Distance		=	1000
...
--	SHEEP_DEST = SHEEP_DEST + 1
	
--	Move(_Quest.EntityName, GetPosition("sheepDest"))
